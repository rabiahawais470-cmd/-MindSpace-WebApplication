<%@ Page Title="User Management" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="UserManagement.aspx.cs" Inherits="MindSpace.UserManagement" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        <div class="container">
            ...
            <p>Add, edit, and manage all registered users</p>
        </div>
    </div>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex gap-2 mb-3 flex-wrap align-items-center">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by name, username, or email..." style="max-width:350px;" />
            ...
            <span class="ms-auto text-muted small">
                Total: <strong><asp:Literal ID="litCount" runat="server" /></strong> users
            </span>
        </div>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lbtnDelete" runat="server" CssClass="btn btn-sm btn-outline-danger"
                                    ...
                                    OnClientClick="return confirmDelete('Delete this user? They will be deactivated.');">
