    ...
    public partial class ProgressTracking : Page
    {
        ...
        private void LoadAchievements(int userID)
        {
            ...
            var badges = new List<(string Icon, string Name, string Desc, bool Unlocked)>
            {
                ...
                ("✅", "Quiz Passer",      "Passed your first quiz",              quizzesPassed >= 1),
                ("⭐", "High Achiever",   "Scored 70%+ on 3 or more quizzes",    highScores   >= 3),
                ("💬", "Community Voice",  "Made your first forum post",           forumPosts   >= 1),
                ("🤝", "Forum Regular",    "Made 5+ forum contributions",          forumPosts   >= 5),
                ("🔥", "Dedicated Learner","Completed a quiz after 3 enrollments", enrolled>=3 && quizzesTaken>=1),
            };
